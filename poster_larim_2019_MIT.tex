...
\headerbox{$N_e$: WL-kcor versus EUV-aia}{name=KCORTom_DEMT,column=1.4,below=Tom,span=1.6}{
{\footnotesize\sf
\begin{center}
  Comparación de $N_e$ a partir de Tomografía EUV (izquierda) y Luz Blanca (derecha)\\  
  ...
  \hrulefill
  \saltito
  Assuming that the plasma is isothermic in each tomographic voxel, the coronal irregularity factor $X$ scales as
  ...
  \saltito
  To jointly determine the values of $\AFe$ and $X$ it is necessary to consider the correlation between the distributions of $N_e$ and $T_e$. This motivates the development of a new tomographic technique: dubbed MIT
